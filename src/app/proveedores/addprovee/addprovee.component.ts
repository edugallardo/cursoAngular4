...
export class AddproveeComponent implements OnInit {
  ...
  onSubmit() { // Al enviar el formulario, se ejecuta este método que tiene puesto

    // Todos los valores de los inputs del formulario, se guardarán en las variables de este contructor
    ...
    this.formpro.reset(); // Al enviar el formulario se reinician los campos
  }
